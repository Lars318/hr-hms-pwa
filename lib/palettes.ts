// Edit this file to add or tweak palettes.
// Each value is "H S% L%" for use in hsl(var(--...)).
...
export const PALETTES: Palette[] = [
  {
    name: "sage",
    label: "Sage & Terrakotta",
    light: {
      background:          "36 25% 97%",
      foreground:          "30 35% 14%",
      card:                "0 0% 100%",
      "card-foreground":   "30 35% 14%",
      popover:             "0 0% 100%",
      "popover-foreground":"30 35% 14%",
      primary:             "100 25% 37%",
  ...
  },
  {
    ...
    light: {
      ...
      card:                "0 0% 100%",
      "card-foreground":   "210 35% 14%",
      popover:             "0 0% 100%",
      "popover-foreground":"210 35% 14%",
      primary:             "200 55% 38%",
      "primary-foreground":"0 0% 100%",
      secondary:           "40 28% 90%",
      "secondary-foreground":"30 35% 20%",
  ...
  },
  {
    ...
    light: {
      ...
      foreground:          "28 35% 12%",
      card:                "0 0% 100%",
      "card-foreground":   "28 35% 12%",
      popover:             "0 0% 100%",
      "popover-foreground":"28 35% 12%",
      primary:             "95 30% 35%",
      "primary-foreground":"0 0% 100%",
      secondary:           "38 25% 88%",
      "secondary-foreground":"28 35% 18%",
      muted:               "40 18% 92%",
